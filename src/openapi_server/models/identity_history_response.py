...
from openapi_server.models.identity_history_item import IdentityHistoryItem
...
class IdentityHistoryResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [IdentityHistoryItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
