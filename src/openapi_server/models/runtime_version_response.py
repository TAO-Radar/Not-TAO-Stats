...
from openapi_server.models.runtime_version_item import RuntimeVersionItem
try:
...
class RuntimeVersionResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [RuntimeVersionItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
