...
from openapi_server.models.account_history_item import AccountHistoryItem
...
class AccountHistoryResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [AccountHistoryItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
