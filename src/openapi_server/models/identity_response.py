...
from openapi_server.models.identity_item import IdentityItem
...
class IdentityResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [IdentityItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
