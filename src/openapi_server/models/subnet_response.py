...
from openapi_server.models.subnet_item import SubnetItem
try:
...
class SubnetResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [SubnetItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
