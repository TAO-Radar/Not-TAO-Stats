...
from openapi_server.models.accounting_item import AccountingItem
...
class AccountingResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [AccountingItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
