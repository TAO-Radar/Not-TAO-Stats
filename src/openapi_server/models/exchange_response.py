...
from openapi_server.models.exchange_item import ExchangeItem
...
class ExchangeResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ExchangeItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
